...
├── experiments/                   # 实验脚本
├── analysis/                      # 可视化
├── 困难任务设计.md                 # 任务设计与数据集分析文档
└── test_*.py                      # 测试套件 (27 tests, no LLM required)
```
...
```bash
python test_new_architecture.py    # 11 tests
python test_protocol.py            # 8 tests
python test_sgd_smo.py             # 8 tests
```
